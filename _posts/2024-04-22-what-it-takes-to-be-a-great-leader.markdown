...
Maybe you wonder: what makes people feel included in organisations? Feel that they are treated fairly and respectfully, are valued and belong? Well many things, like the purpose of the company, or the way people behave and what they say. A study showed that what leaders say and do have a huge impact on how collaborators feel included.

The key to be an inclusive leader relies on these 5 key points:

- Have a visible commitment: They articulate authentic  commitment to diversity, challenge the status quo, hold others  accountable, and make diversity and inclusion a personal priority.
...
The first one is from a book called the 'The five dysfunctions of a team' from Patrick Lencioni.
...
Here are three core skills of trusted advisors:

- Earning trust
- Giving advice
- Building relationships

First, you have to build trust, by showing your technical skills in the case of a technical assignment, instead of talking do things and show them to your client!
